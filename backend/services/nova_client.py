...
class NovaClient:
    ...
    def __init__(
        ...
        if normalized_access_key and not normalized_access_key.upper().startswith("ASIA"):
            # Session token is only valid for temporary credentials (ASIA*).
            normalized_session_token = None
